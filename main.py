...
if __name__ == "__main__":
    ...
    # the argumSamplerents from `batch_filter_func_kwargs` applied to it
    
    # Alternatively, you can partially apply the arguments:  
    # partial_format_dict_batch = partial(
	# 	format_dict_batch, 
    ...
    for x in get_linear_batches_from_dataset(
        ...
        batch_filter_func_kwargs=\
		  {'key_order':['text', 'label'], 'key_funcs':kfs},
        do_shuffle=True,
        ):
        for item in x['text']:
